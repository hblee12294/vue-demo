  ...
  data () {
    return {
      questions: [{
        ...
        content: '全蛋液怎样蒸没有孔而且还能和蒸碗完全脱离开？',
        href: '/salon/60756/',
        participants: 18
      }, {
        content: '有什么蛋糕可以不用烤箱和奶油呢？',
        href: '/salon/60780/',
        participants: 30
      }]
    }
